...
def readArff(filehandle) :
    ...
    for index in range(0, len(attribLines) - 1) :
...
if __name__ == '__main__' :
    ...
    if sys.argv[1].startswith("--pfile") :
        ...
        print "Data: ", data
        alist = getAttrList(attrs)
        print ruleLearning.buildDecisionList(alist, data)
        print ruleLearning.buildRuleset(alist, data)
